...
class Linked_Roles(commands.GroupCog, name="linkedroles"):
	...
	@app_commands.choices(link=[app_commands.Choice(name="♡੭𓈒 Beast Donor ♡੭𓈒", value="top_dono"), app_commands.Choice(name="࿔･ﾟ♛ Weekly Topper ♛ ࿔･ﾟ", value="weekly_top"), app_commands.Choice(name="Ex-Staff of TGK", value="ex_staff")])
